...
db.lineHeight(FONT_SIZE*0.95)
db.lineHeight(FONT_SIZE*1.1)
#db.tracking(-1)
#db.textBox("أشهد يا إلهي بأنك خلقتني لعرفانك وعبادتك "*19,
#   (M+(M*0), M+(M*1.5), W-(M*2), H-(M*5)), align="right")
top = 24.5
db.text("أشهد يا إلهي", (M+(U*(31.75)), M+(U*(top))),  align="right")
db.text("بأنك خلقتني",  (M+(U*(28.5)),  M+(U*(top-7))),  align="right")
db.text("بأنك خلقتني",  (M+(U*(28.5)),  M+(U*(top-21))),  align="right")
db.image("images/alpha/ai-art/fig-001.png", (U*0.7, U*5.0), alpha=1.0)
db.text("أشهد يا إلهي", (M+(U*(31.75)), M+(U*(top-14))),  align="right")
