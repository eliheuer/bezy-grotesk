...
db.fill(0.8)
db.fontSize(128*1.88)
db.tracking(-6)
# MAIN TEXT ----------------------------------------------------
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(27))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(23))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(19))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(15))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(11))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(7))), align="left")
db.text("believe in som\uF004ing", (M-(U*(0.25)), M+(U*(3))), align="left")
...
db.text("0x7ca26",     (M+(U*(32)), M+(U*(0))),  align="right")
